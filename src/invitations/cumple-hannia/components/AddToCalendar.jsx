...
const AddToCalendar = () => {
    ...
    const event = config.calendarEvent;
    ...
    const outlookUrl = `https://outlook.live.com/calendar/0/deeplink/compose?subject=${encodeURIComponent(event.title)}&body=${encodeURIComponent(event.description)}&startdt=${event.outlookStart}&enddt=${event.outlookEnd}&location=${encodeURIComponent(event.location)}`;
