...
const Footer = () => {
    return (
        <footer className="py-12 bg-secondary text-center text-slate-400 text-sm border-t border-slate-100">
            <p className="font-serif italic text-lg mb-2 text-slate-600">{config.footer.names}</p>
            <p className="mb-4">{config.footer.message || 'Hecho con amor para nuestra boda.'}</p>
            <a
