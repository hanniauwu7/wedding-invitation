                ...
                <div className="flex-1 min-w-[300px] max-w-sm bg-white p-8 rounded-2xl shadow-sm border border-stone-100 text-center hover:-translate-y-1 transition-transform duration-300">
                    ...
                    <div className="bg-secondary p-5 rounded-xl border-l-4 border-primary mt-2">
                        <p className="text-sm text-slate-600 italic leading-relaxed">
                            {config.details.adultsOnlyMessage || '"Amamos a los niños, pero queremos que este día papá y mamá celebren sin preocupaciones."'}
                        </p>
            ...
            {config.details.dressCode && (
                <div className="flex-1 min-w-[300px] max-w-sm bg-white p-8 rounded-2xl shadow-sm border border-stone-100 text-center hover:-translate-y-1 transition-transform duration-300">
                    ...
                    {config.details.dressCodeImage && (
                        <img
                            src={`${basePath}/img/${config.details.dressCodeImage}`}
                    ...
                    {config.details.avoidColors && (
                        <p className="text-xs text-slate-500">
                            ...
                            <span className="line-through text-slate-400">{config.details.avoidColors}</span>
                        </p>
                    )}
                </div>
            )}
