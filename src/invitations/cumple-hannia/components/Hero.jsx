    ...
    return (
        <header className="relative min-h-[100dvh] w-full flex flex-col items-center justify-end pb-32 md:pb-20 text-center">
            ...
            <div className="absolute inset-0 z-0 will-change-transform">
                <img
                    src={`${basePath}/img/${config.hero.coverImage}`}
                    alt="Fondo"
                    loading="eager"
                    decoding="async"
            ...
            <div className="relative z-10 text-white animate-fade-in space-y-4 px-6 pb-16 md:pb-8">
                <h1 className="font-serif text-5xl sm:text-6xl md:text-8xl drop-shadow-lg leading-tight">{config.hero.heading}</h1>
                <p className="text-lg md:text-xl uppercase tracking-[0.3em] font-light">{config.hero.subheading}</p>
