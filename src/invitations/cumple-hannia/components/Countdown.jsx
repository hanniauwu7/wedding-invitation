...
const Countdown = () => {
    ...
    useEffect(() => {
        const weddingDate = new Date(config.countdown.dateTime).getTime();
            ...
            <div className="max-w-4xl mx-auto">
                ...
                {!isTime && (
                    <div className="mb-8 animate-fade-in">
                        <p className="text-xl md:text-3xl text-slate-700 font-serif mb-2">{config.countdown.displayDate}</p>
                        <p className="text-lg text-slate-500 uppercase tracking-widest">{config.countdown.displayYear}</p>
                    </div>
                )}
